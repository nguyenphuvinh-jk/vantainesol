                    ...
                    <form class="new-added-form" action="{{ URL::to('/quan-ly-danh-muc/loai-xe/luu') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="ten_loaixe">
                                @if ($errors->has('ten_loaixe'))
                                    <p class="text-danger font-italic">{{ $errors->first('ten_loaixe') }}</p>
                                @endif
                            </div>
