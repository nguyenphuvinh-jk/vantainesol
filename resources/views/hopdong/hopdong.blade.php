            ...
            <div class="card height-auto">
                    ...
                    <div class="card-body">
                        @foreach ($hopdong_edit as $key => $hd_edit)
                            ...
                            <form class="new-added-form"
                                action="{{ URL::to('/quan-ly-khach-hang/hop-dong-van-chuyen/capnhat/' . $hd_edit->hd_id) }}"
                                method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                        <label>Mã Hợp Đồng</label>
                                        <input type="text" placeholder="" class="form-control" name="hd_id"
                                            value="{{ $hd_edit->hd_id }}" disabled>
                                        @if ($errors->has('hd_id'))
                                        ...
                                        <select class="select2" name="ten_kh">
                                            ...
                                            @foreach ($khachhang as $key => $kh)
                                                <option value="{{ $kh->kh_id }}"
                                                    {{ $hd_edit->ten_kh == $kh->kh_id ? 'selected' : '' }}>
                                                    {{ $kh->ten_kh }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                            data-position='bottom right' name="ngaybatdau_hd"
                                            value="{{ \Carbon\Carbon::parse($hd_edit->ngaybatdau_hd)->format('d/m/Y') }}">
                                    ...
                                    <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                            data-position='bottom right' name="ngayhethan_hd"
                                            value="{{ \Carbon\Carbon::parse($hd_edit->ngayhethan_hd)->format('d/m/Y') }}">
                                        <i class="far fa-calendar-alt"></i>
                                    ...
                                    @if (\Illuminate\Support\Facades\Auth::check())
                                        <input type="hidden" placeholder="" class="form-control" name="nguoitao"
                ...
                @else
                    <div class="card-body">
                        ...
                        <form class="new-added-form" action="{{ URL::to('/quan-ly-khach-hang/hop-dong-van-chuyen/luu') }}"
                            method="post">
                            @csrf
                            <div class="row">
                                <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a onclick="return confirm('Bạn muốn xóa trường này?')"
                                                        class="dropdown-item"
                                                        href="{{ URL::to('/quan-ly-khach-hang/hop-dong-van-chuyen/xoa/' . $hd->hd_id) }}"><i
                                                            class="fas fa-times text-orange-red"></i>Xóa</a>
                                                    <a class="dropdown-item"
                                                        href="{{ URL::to('/quan-ly-khach-hang/hop-dong-van-chuyen/sua/' . $hd->hd_id) }}"><i
