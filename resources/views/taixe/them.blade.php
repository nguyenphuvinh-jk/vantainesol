...
@section('contents')
    <div class="card height-auto">
        <div class="card-body">
            ...
            <form class="new-added-form" action="{{ URL::to('/quan-ly-tai-xe/thong-tin-tai-xe/them/luu') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>Tên</label>
                        <input type="text" placeholder="" class="form-control" name="ten_taixe" value="{{old('ten_taixe')}}">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker" data-position='bottom right' name="ngaysinh" value="{{old('ngaysinh')}}">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="sdt" value="{{old('sdt')}}">
                        @if ($errors->has('sdt'))
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>Địa chỉ</label>
                        <input type="text" placeholder="" class="form-control" name="diachi" value="{{old('diachi')}}">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        <label>Số CCCD</label>
                        <input type="text" placeholder="" class="form-control" name="CCCD" value="{{old('CCCD')}}">
                        @if ($errors->has('CCCD'))
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="tknh" value="{{old('tknh')}}">
                        @if ($errors->has('tknh'))
