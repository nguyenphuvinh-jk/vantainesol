                ...
                <div class="card-body">
                    @foreach ($phatsinhxe_edit as $key => $ps_edit)
                        ...
                        <form class="new-added-form"
                            action="{{ URL::to('/quan-ly-xe/cap-phat-nhien-lieu/sua/capnhat/' . $ps_edit->phatsinhxe_id) }}"
                            method="post">
                            @csrf
                            <div class="row">
