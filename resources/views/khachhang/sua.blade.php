...
@section('title')
    <title>NESOL | Sửa khách hàng</title>
@endsection
...
@section('contents')
    <div class="card height-auto">
        <div class="card-body">
            @foreach($khachhang_edit as $key => $kh_edit)
            <div class="heading-layout1">
                ...
                <form class="new-added-form" action="{{ URL::to('/quan-ly-khach-hang/khach-hang/sua/capnhat/'.$kh_edit->kh_id) }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Mã khách hàng </label>
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->kh_id}}" name="kh_id" disabled>
                            @if ($errors->has('kh_id'))
                                <p class="text-danger font-italic">{{ $errors->first('kh_id') }}</p>
                            @endif
                        </div>
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Tên khách hàng </label>
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->ten_kh}}" name="ten_kh">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->sdt_kh}}" name="sdt_kh">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Địa chỉ </label>
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->diachi_kh}}" name="diachi_kh">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->masothue_kh}}" name="masothue_kh">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Fax </label>
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->fax_kh}}" name="fax_kh">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->sotk_kh}}" name="sotk_kh">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->ten_nganhang}}" name="ten_nganhang">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            ...
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->nguoidaidien_kh}}" name="nguoidaidien_kh">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Chức vụ</label>
                            <input type="text" placeholder="" class="form-control" value="{{$kh_edit->chucvu_kh}}" name="chucvu_kh">
