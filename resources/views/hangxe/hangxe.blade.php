                    ...
                    <div class="table-responsive">
                        <table class="table display data-table text-nowrap" id="hangxe_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <a onclick="return confirm('Có chắc muốn xoá chưa?')" class="dropdown-item" href="{{URL::to('/quan-ly-danh-muc/hang-xe/xoa/'.$hx->hangxe_id)}}"><i class="fas fa-times text-orange-red"></i>Xóa</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
